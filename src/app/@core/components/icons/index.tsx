...
export const GitHubIcon = () => (
  <svg
    ...
    viewBox="0 0 32 32"
    fill="none"
    data-inject-url="https://iuricode.com/assets/icons/github.svg"
  >
    <path
...
export const BehanceIcon = () => (
  <svg
    ...
    viewBox="0 0 32 32"
    fill="none"
    data-inject-url="https://iuricode.com/assets/icons/behance.svg"
  >
    <path
      d="M21 10H29"
      stroke="currentColor"
...
export const LinkedInIcon = () => (
  <svg
    ...
    viewBox="0 0 32 32"
    fill="none"
    data-inject-url="https://iuricode.com/assets/icons/linkedin.svg"
  >
    <path
...
export const DiscordIcon = () => (
  <svg
    ...
    viewBox="0 0 32 32"
    fill="none"
    data-inject-url="https://iuricode.com/assets/icons/discord.svg"
  >
    <path
...
export const BookOpenIcon = ({ width }: Props) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={width || "24"}
    height="24"
...
export const BriefCaseIcon = ({ width }: Props) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={width || "24"}
    height="24"
